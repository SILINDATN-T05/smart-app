...
export class AuthService {
  ...
  getScheduled() {
    return this.http.get(this.env.API_URL + '/api/patient/get-scheduled');
  }
  getPaymentRequired() {
    return this.http.get(this.env.API_URL + '/api/patient/get-payment-required');
  }
  getOnPhysical() {
    return this.http.get(this.env.API_URL + '/api/patient/get-on-physical');
  }
  getOnTechnical() {
    return this.http.get(this.env.API_URL + '/api/patient/get-on-technical');
  }
  getCompleted() {
    return this.http.get(this.env.API_URL + '/api/patient/get-completed');
  }
  getCertIssued() {
    return this.http.get(this.env.API_URL + '/api/patient/get-cert-issued');
  }
  patientsCheckIn(data) {
    return this.http.post(this.env.API_URL + '/api/patient/check-in', data);
  }
